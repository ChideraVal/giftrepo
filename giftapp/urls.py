...
urlpatterns = [
    ...
    path('reportadview/', views.report_ad_view, name='report_ad_view'),
    path('viewads/', views.view_ads, name='view_ads'),
    ...
    # path("all-gifts/", views.all_gifts_data, name="all_gifts_data"),
    # path("send-gift/", views.send_gift_data, name="send_gift_data"),
    ...
    # path("gifts/stats/", views.gift_stats, name="view_gift_stats"),
    # path("gifts-stats/<int:gift_transaction_id>/", views.gift_stats_data, name="gift_stats_data"),
