...
class GiftTransaction(models.Model):
    ...
    early_claim_fee = models.PositiveIntegerField(default=0, help_text="Number of coins paid to claim the gift early if not dropped. FF gifts cannot have early claim fee greater than 0.")
    claim_fee = models.PositiveIntegerField(default=0, help_text="Number of coins paid to claim the gift if dropped.")
